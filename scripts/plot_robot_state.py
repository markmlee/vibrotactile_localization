...
def plot_entire_state():
    ...
    #ee is 4x4 matrix, get translation from [0,1,2 row of 4th column]
    for i in range(len(ee_t_list)):
        matrix4x4 = ee_t_list[i]
        translation_t[i] = matrix4x4[12:15] #--> translation in 4x4 matrix for [x,y,z]
        

    #plot 3x1 subplot of x_t, y_t, z_t
    fig, axs = plt.subplots(3, 1)
    fig.suptitle('Recorded trajectory')
