...
def create_ast_model(cfg):
    model = AST(
        cfg,
        img_size=(cfg.n_mels, cfg.input_spectrogram_bins),
        patch_size=(10, 10),  # Adjust based on your spectrogram size
        in_chans=cfg.num_channel,
        num_outputs=3,  # height, x, y
        embed_dim=768,
        depth=12,
        num_heads=12,
        mlp_ratio=4.,
